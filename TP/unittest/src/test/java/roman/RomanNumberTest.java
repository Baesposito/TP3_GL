...
public class RomanNumberTest {
  ...
  public void fromRomanKnownValues() {
	...
	// teste bonne valeur décimale
  	@Test
	public void isGoodInt(){
		RomanNumber.valueOf(25);
	}
	
	// teste bonne valeur roman
  	@Test
	public void isGoodRom(){
		RomanNumber.valueOf("XIV");
	}
  ...
  public void toRomanZero() {
	...
	// lot of repetition symbole
  	@Test(expected = IllegalArgumentException.class)
	public void isRepetitionSymbole(){
		RomanNumber.valueOf("VIIII");
	}
	
	// repetition paire
  	@Test(expected = IllegalArgumentException.class)
	public void isRepetitionPaire(){
		RomanNumber.valueOf("VV");
	}
	
	// repetition antécédant
	@Test(expected = IllegalArgumentException.class)
	public void isIncorrectsAnt(){
